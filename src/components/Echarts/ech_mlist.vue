...
export default {
  ...
  methods: {
    ...
    drawChart () {
      ...
      var width = document.getElementById(this.echarts).offsetWidth
         let list = [];
      let bottom = 25;
      let height = 25;
        ...
        tooltip: {
          ...
          formatter: function (params) {
            ...
            params.forEach(function (item) {
              axisName = "<div style='margin-bottom:0px'>" + item.axisValue + "</div>"
              var itemValue = "<div style='margin-bottom:5px'>" + item.marker + item.seriesName + ":&nbsp&nbsp&nbsp&nbsp <div style='float: right;'><b>" + item.data + "%</b></div></div>"
              result += itemValue
            })
