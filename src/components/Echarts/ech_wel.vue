      ...
      var option = {
        ...
        tooltip: {
          ...
          formatter: function (params) {
            ...
            params.forEach(function (item) {
              axisName =
                "<div style='margin-bottom:0px'>" + item.axisValue + '</div>'
              var itemValue =
                "<div style='margin-bottom:5px'>" +
                item.marker +
                item.seriesName +
                ":&nbsp&nbsp&nbsp&nbsp <div style='float: right;'><b>" +
                item.data +
                '%</b></div></div>'
              result += itemValue
            })
            var allResult = axisName + '' + result
            return allResult
          },
        },
        legend: {
        ...
        xAxis: {
          ...
          axisLabel: {
           ...
           axisTick:{
                lineStyle:{color:'#ededed'}    // x轴刻度的颜色
                },
        },
        yAxis: {
          type: 'value',
